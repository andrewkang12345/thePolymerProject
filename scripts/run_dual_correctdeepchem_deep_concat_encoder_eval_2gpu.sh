...
RUN_NAME="${BASE_RUN}_concatenc"
CKPT="outputs/${BASE_RUN}/best.pt"
GPU2_TASKS=("Egc" "Egb" "Eea" "Ei")
GPU3_TASKS=("Xc" "EPS" "Nc" "Eat")

echo "=== Downstream eval: concat-through-encoder input on GPUs 2-3 ==="
...
echo "=== Concat-through-encoder downstream eval complete ==="
