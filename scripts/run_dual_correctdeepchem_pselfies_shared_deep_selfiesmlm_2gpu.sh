...
RUN_NAME="dual_correctdeepchem_pselfies_shared_deep_selfiesmlm_vw1_tw1_e2"
CKPT="outputs/${RUN_NAME}/best.pt"
GPU2_TASKS=("Egc" "Egb" "Eea" "Ei")
GPU3_TASKS=("Xc" "EPS" "Nc" "Eat")

echo "=== Phase 1: 2-epoch deep corrected dual run with pSELFIES MLM on GPUs 2-3 ==="
...
echo "=== pSELFIES-MLM deep corrected dual run complete ==="
