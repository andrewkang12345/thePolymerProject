...
SOURCE_RUN="dual_correctdeepchem_pselfies_shared_deep_selfiesmlm_vw1_tw1_e8"
RUN_NAME="dual_correctdeepchem_pselfies_shared_deep_selfiesmlm_vw1_tw1_e16"
RESUME_CKPT="outputs/${SOURCE_RUN}/best.pt"
CKPT="outputs/${RUN_NAME}/best.pt"
GPU2_TASKS=("Egc" "Egb" "Eea" "Ei")
GPU3_TASKS=("Xc" "EPS" "Nc" "Eat")

echo "=== Phase 1: continue pSELFIES-MLM deep corrected dual run to epoch 16 on GPUs 2-3 ==="
...
echo "=== pSELFIES-MLM deep corrected dual e16 run complete ==="
